...
abstract class Data
{
    ...
    */
     ...
     * @return Data
     */
    public function find(?string $terms = null, ?string $params = null, string $columns = "*"): Data
    {
        if ($terms) {
     ...
     * @return Data|null
     */
    public function findById(int $id, string $columns = "*"): ?Data
    {
     ...
     * @return Data|null
     */
    public function group(string $column): ?Data
    {
     ...
     * @return Data|null
     */
    public function order(string $columnOrder): ?Data
    {
     ...
     * @return Data|null
     */
    public function limit(int $limit): ?Data
    {
     ...
     * @return Data|null
     */
    public function offset(int $offset): ?Data
    {
